...
`api.sys.<your-foundation-domain>`.
...
|---|---|---|
| Foundation | api.sys.<foundation-A-domain> | api.sys.<foundation-B-domain> |
| AI plan | <your-ai-plan> | chat-and-tools-model (TBC) |
